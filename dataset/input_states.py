...
with open('/export/home/u17/yoomi/term_project/dataset/states.csv') as csvfile:
    ...
    for row in myCSVReader:
        ...
        sql = "INSERT INTO states(id, name, abbreviation, census_region_name) VALUES (%(id)s,%(name)s,%(abbreviation)s,%(census_region_name)s)"
